...
- Live response IDs are tied to the numeric question index in Firestore rules, preventing alternate `question_key` values from creating duplicate answers for the same active question.
