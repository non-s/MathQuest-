...
const requiredFiles = [
  ...
  "scripts/check-mathquest-production.js",
...
if (exists(".github/workflows/quality.yml")) {
  ...
  for (const token of ["check-workflows.js", "validate-firebase-config.js", "check-mathquest-production.js", "check-html-assets.js", "check-repo-contracts.js"]) {
